...
survATRT_SEX<-function(final){
 ...
 print(fit_ATRT_SEX)
 print(ggsurvplot(fit_ATRT_SEX, data = dt_SEX))
...
survATRT_AGE<-function(final){
  ...
  print(fit_ATRT_AGE)
  print(ggsurvplot(fit_ATRT_AGE, data = dt_AGE))
...
survATRT_WEIGHT<-function(final){
  ...
  print(ggsurvplot(fit_ATRT_WEIGHT, data = dt_WEIGHT))
...
survATRT_marker<-function(final){
  ...
  print(ggsurvplot(fit_ATRT_marker, data = dt_marker))
...
survATRT_AESEVCD<-function(final){
  ...
  print(ggsurvplot(fit_ATRT_AESEVCD, data = dt_AESEVCD))
